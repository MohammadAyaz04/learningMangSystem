...
setFilteredCourse(tempCourses)
  ...
  return (
    ...
    <div className='relative md:px-36 px-8 pt-20 text-left'>
      ...
      {input && <div className='inline-flex items-center gap-4 px-4 py-4 border mt-8-mb-8 text-gray-600'>
      <p>
        {input}
      </p>
      <img src={assets.cross_icon} alt="crossicon" onClick={()=>navigate('/course-list')}/>
      </div>
      }
